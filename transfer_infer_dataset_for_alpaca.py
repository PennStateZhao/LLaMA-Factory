...
def build_dataset(output_dir="./data", cut_length=720):
    ...
    save_file(format_d, f"{output_dir}/infer_520_from_train_1400.json")
    save_file(sampled_data, f"{output_dir}/infer_520_from_train_1400_raw.json")
